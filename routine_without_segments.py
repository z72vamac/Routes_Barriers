...
#        segmentos_visitar = np.genfromtxt('./instancias/segmentos' + str(nP) + '-' + str(instance) + '.csv', delimiter = ',')
...
#        dataframe.to_csv('./resultados/resultados_without_prepro_segmentos_visitar_updated.csv')
        dataframe.to_csv('./resultados/resultados_without_prepro_segmentos_visitar_updated-90-100.csv')
