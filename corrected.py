...
def corrected(barriers, neighborhoods, prepro=True, log=False, dominant = False, picture=False, time_limit=7200, init=False):
    ...
    if not(dominant):
        ...
        edges_total = [(a, b, c, d) for (a, b) in vertices_total for (c, d) in vertices_total if (a != c) and (b != d)]
        ...
        for (a, b, c, d) in edges_neighborhood:
            for (e, f, g, h) in edges_barrier:
                alpha_index.append((a, b, e, f, g, h))
