...
\begin{axis}[
	...
	\addplot [semithick, white!29.8039215686275!black]
	table {%
	0.102 0.189291086196899
	0.298 0.189291086196899
	};
	\addplot [semithick, white!29.8039215686275!black]
	table {%
...
\caption{Runtime of the model \eqref{form:H-TSPN} without and with strengthening when the neighborhoods are segments and balls.}
\label{fig:Fig4}
\end{figure}