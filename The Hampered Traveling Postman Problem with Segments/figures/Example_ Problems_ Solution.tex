...
\begin{figure}[h!]
	...
	\caption{\CV{Optimal solution for the instance of the \SPPN}}
	\centering
	\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm, scale=0.45]
		...
		\hspace{0.2 in}
		\begin{minipage}{.3\textwidth}
		\caption{\CV{Optimal solution for the instance of the \TSPHN}}
		\centering
		\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm, scale=0.45]
			\begin{axis}[
				x=0.1cm,y=0.1cm,
			...
			\end{axis}
		\end{tikzpicture}
		\label{fig:solution_tsph}
		\end{minipage}
			\hspace{0.2 in}
		\begin{minipage}{.3\textwidth}
		\caption{\CV{Optimal solution for the instance of the \TSPN}}
		\centering
	\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1cm,y=1cm, scale=0.45]
	\begin{axis}[
	x=0.1cm,y=0.1cm,
