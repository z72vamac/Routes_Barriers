...
%	\bigskip
	...
	The rationale of the formulation for the \TSPHN \ is to consider the variant called Steiner TSP (STSP) (see \citet{letchford2013}), where some nodes in $\VB$ do not have to be visited, but if necessary, they can be visited more than once. 
%	
