...
with_prepro_segmentos = pd.read_csv('resultados_with_prepro_segmentos_visitar_updated.csv')
with_prepro_segmentos['Preprocessing'] = True
with_prepro_segmentos['Neighborhood'] = 'Segment'

without_prepro_segmentos = pd.read_csv('resultados_without_prepro_segmentos_visitar_updated.csv')
without_prepro_segmentos['Preprocessing'] = False
without_prepro_segmentos['Neighborhood'] = 'Segment'

with_prepro_bolas = pd.read_csv('resultados_with_prepro_bolas_visitar_updated.csv')
with_prepro_bolas['Preprocessing'] = True
with_prepro_bolas['Neighborhood'] = 'Ball'

without_prepro_bolas = pd.read_csv('resultados_without_prepro_bolas_visitar_updated.csv')
