...
def tspn_b(
    ...
    if not (dominant):
        ...
        for a, b, c, d, e, f in alpha_index:
            ...
            if (c, d, e, f) in indices_barriers:
                if (a, b) in vertices_neighborhood:
                    ...
                    if U < 0 and variable_fixing:
                        alpha[a, b, c, d, e, f] = 0

                    # If L is positive, the whole neighborhood is in the hyperplane generated by the segment
                    elif L > 0 and variable_fixing:
                        alpha[a, b, c, d, e, f] = 1
                    else:
                        model.addConstr(
                    ...
                    if (af.determinant(barriers[a][b], barriers[c][d], barriers[e][f]) <= 0) and variable_fixing:
                        alpha[a, b, c, d, e, f] = 0
                    else:
                        alpha[a, b, c, d, e, f] = 1
            else:
        ...
        results[7] = model.Runtime
        results[8] = time_elapsed
