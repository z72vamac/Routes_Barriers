...
def tspn_b2(barriers, neighborhoods, prepro=True, log=False, dominant=False, picture=False, time_limit=7200, init=False):
    if not (dominant):
        ...
        for a, b, c, d in indices_barriers:
            for e, f, g, h in edges_neighborhood:
                alpha_index.append((a, b, c, d, e, f, g, h))
        ...
        dist_index = edges_neighborhood

        dist_barriers = {}

        for a, b, c, d in edges_barrier:
            dist_barriers[a, b, c, d] = np.linalg.norm(np.array(barriers[a][b]) - np.array(barriers[c][d]))
        ...
        if init:
            results_h, y_indices, g_indices = heuristic2(barriers, neighborhoods, prepro=True, log=False,
                                                         dominant=False, picture=False)
        ...
        # alpha-C
        for a, b, c, d, e, f, g, h in alpha_index:
            # Dos primeras
            # print((a, b, c, d, e, f))
            L = -1e25
            U = 1e25
            if (e, f, g, h) in indices_barriers:
                if a < 0:
                    model.addConstr((1 - alpha[a, b, c, d, e, f, g, h]) * L <= af.determinant([point[a, b, 0], point[a, b, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[c][d], barriers[e][f], barriers[g][h]))
                    model.addConstr(af.determinant([point[a, b, 0], point[a, b, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[c][d], barriers[e][f], barriers[g][h]) <= U * alpha[a, b, c, d, e, f, g, h])
                if c < 0:
                    model.addConstr((1 - alpha[a, b, c, d, e, f, g, h]) * L <= af.determinant([point[c, d, 0], point[c, d, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[a][b], barriers[e][f], barriers[g][h]))
                    model.addConstr(af.determinant([point[c, d, 0], point[c, d, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[a][b], barriers[e][f], barriers[g][h]) <= U * alpha[a, b, c, d, e, f, g, h])

                # if c < 0:
                #     model.addConstr((1 - alpha[a, b, c, d, e, f, g, h]) * L <= af.determinant([point[c, d, 0], point[c, d, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[a][b], barriers[e][f], barriers[g][h]))
                #     model.addConstr(af.determinant([point[c, d, 0], point[c, d, 1]], barriers[e][f], barriers[g][h])*af.determinant(barriers[a][b], barriers[e][f], barriers[g][h]) <= U * alpha[a, b, c, d, e, f, g, h])

            if (a, b, c, d) in indices_barriers:
                if e < 0:
                    model.addConstr((1 - alpha[a, b, c, d, e, f, g, h]) * L <= af.determinant(barriers[a][b], [point[e, f, 0], point[e, f, 1]], barriers[g][h])*af.determinant(barriers[c][d], [point[e, f, 0], point[e, f, 1]], barriers[g][h]))
                    # model.addConstr(af.determinant(barriers[a][b], [point[e, f, 0], point[e, f, 1]], barriers[g][h])*af.determinant(barriers[c][d], barriers[e][f], barriers[g][h]) <= U * alpha[a, b, c, d, e, f, g, h])

                if g < 0:
                    model.addConstr((1 - alpha[a, b, c, d, e, f, g, h]) * L <= af.determinant(barriers[a][b], barriers[e][f], [point[g, h, 0], point[g, h, 1]])*af.determinant(barriers[c][d], barriers[e][f], [point[g, h, 0], point[g, h, 1]]))
                    # model.addConstr(af.determinant(barriers[a][b], barriers[e][f], [point[g, h, 0], point[g, h, 1]])*af.determinant(barriers[c][d], barriers[e][f], [point[g, h, 0], point[g, h, 1]]) <= U * alpha[a, b, c, d, e, f, g, h])

        for a, b, c, d in epsilon_index:
            model.addConstr(epsilon[a, b, c, d] >= gp.quicksum(alpha[a, b, c, d, e, f, g, h] for e, f, g, h in indices_barriers)-len(indices_barriers)+1)
            model.addConstr(len(barriers)*epsilon[a, b, c, d] <= gp.quicksum(alpha[a, b, c, d, e, f, g, h] for e, f, g, h in indices_barriers))
        ...
        # for i, j, dim in point_index:
        #     model.addConstr(point[i, j, dim] == neighborhoods[abs(i)-1].center[dim])

        # model.addConstr(alpha[1, 0, 1, 1, 3, 0, -3, 0] == 1)
        # model.addConstr(alpha[1, 0, 1, 1, 3, 0, -2, 0] == 1)
        ...
        # for a, b, c, d in dist_index:
        #     model.addConstr(dist[a, b, c, d] == dist[c, d, a, b])
        ...
        objective = gp.quicksum(p[index] for index in p.keys()) + gp.quicksum(
            dist_barriers[index] * y[index] for index in edges_barrier) #+ gp.quicksum(U*alpha[index] for index in alpha.keys())
